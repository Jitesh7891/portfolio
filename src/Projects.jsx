  ...
  const fullstackProjects = [
    ...
    },
    {
      ...
      points: [
        ...
        "Implemented secure user authentication, using bcrypt.js for password hashing"
      ],
    ...
    {
      title: "AdminStar",
    description: "Fully responsive Admin Dashboard with interactive data visualizations",
      tech: ['Material UI','React', 'Chart.js', 'MongoDB', 'Express.js', 'Nivo', 'Node.js', 'Redux Toolkit Query'],
      points: [
       " Crafted a fully responsive React-based admin dashboard using MUI and Nivo for engaging data visualizations",
        "Integrated backend APIs (Node.js + Express) with MongoDB to serve analytics via Redux Toolkit Query",
        "Implemented advanced table features including server-side pagination, filters, and custom UI elements"
      ],

      githubLink: "https://github.com/Jitesh7891/AdminStar/",
      liveLink: "https://adminstar.onrender.com",
      gradient: "from-mycolor-800 to-mycolor-900"
    },
    {
      title: "TaskTracker",
      description: "React Task Tracker where you can login and manage tasks.",
      tech: ['HTML', 'CSS', 'React', 'JavaScript', 'Vite', 'localstorage'],
      points: [
        "Built a modular React-based task tracker with clean UI, login simulation, and real-time task filtering",
        "Enabled category/priority-based filtering with intuitive add/edit/delete features",
        "Persisted tasks using browser localStorage for a seamless local-only experience"
      ],

      githubLink: "https://github.com/Jitesh7891/TaskTracker",
      liveLink: "https://jitesh7891.github.io/TaskTracker/",
      gradient: "from-mycolor-800 to-mycolor-900"
    }
  ];
 ...
 return (
  <section id="projects" className="py-20 bg-gray-900">
    <div className="container mx-auto px-6">
      {/* Full-Stack Projects */}
      <h2 className="text-3xl font-bold text-center mb-12 text-mycolor">Full-Stack Projects</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        {fullstackProjects.map((project, index) => (
          <div key={index} className="group perspective-1000 relative hover:z-10">
              ...
              <div className="bg-gray-800 rounded-lg shadow-md overflow-hidden transition-all duration-500 relative shadow-mycolor-900/10 group-hover:shadow-none">
                ...
                <div className="p-6">
                  ...
                  <div className="flex space-x-4">
                    {project.githubLink && (
                      <a href={project.githubLink} target="_blank" rel="noopener noreferrer" className="text-mycolor hover:text-mycolor-500 transition-colors flex items-center relative overflow-hidden group-hover:font-medium">
                    ...
                    {project.liveLink && (
                      <a href={project.liveLink} target="_blank" rel="noopener noreferrer" className="text-mycolor hover:text-mycolor-500 transition-colors flex items-center relative overflow-hidden group-hover:font-medium">
      ...
      {/* Frontend Projects */}
      <h2 className="text-3xl font-bold text-center mb-12 text-mycolor">Frontend Projects</h2>
